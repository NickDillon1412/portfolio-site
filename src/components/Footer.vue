            ...
            <div class="max-w-lg">
                <div
                    ...
                    <div class="relative inline-flex w-full group/button">
                        <div
                            class="absolute transition-all duration-1000 bg-pink-500 -inset-px rounded-xl blur-sm group-hover/button:opacity-100 group-hover/button:-inset-1 group-hover/button:duration-200 animate-tilt">
                        </div>
