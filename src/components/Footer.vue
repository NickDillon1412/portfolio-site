                ...
                <div
                    ...
                    <div class="relative inline-flex w-full group/button">
                        ...
                        <a href="mailto:nickhds@gmail.com" target="_blank"
                            class="relative inline-flex items-center justify-center w-full px-4 py-2 text-lg font-bold text-white transition-all duration-300 ease-in-out bg-pink-400 sm:w-auto hover:-rotate-3 hover:scale-110 rounded-xl focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500"
